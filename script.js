// ==================== CONFIGURATION ====================
const CONFIG = {
    defaultServer: 'fe215d6b0aaf4e.lhr.life',
    debug: {
        enabled: true,
        logLevel: 'INFO',
        maxLogs: 200,
...
window.addEventListener('load', () => {
    ...
    // ✅ AUTO-FILL DEFAULT SERVER URL
    const serverUrlInput = Utils.getEl('serverURL');
    if (serverUrlInput && !serverUrlInput.value) {
        serverUrlInput.value = CONFIG.defaultServer;
        DEBUG.info('INIT', 'Default server URL filled', { url: CONFIG.defaultServer });
    }
