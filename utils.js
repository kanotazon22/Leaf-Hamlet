/**
 * utils.js - Utility Functions (COMPLETE FIXED)
...
// ==================== STRING UTILITIES (FIXED) ====================
export const StrUtils = {
    /**
     * ⭐ FIXED: Encrypt text using XOR + Base64 (JSON-safe)
     */
    xorCipher(text, key = CONFIG.message.encryptionKey) {
        ...
        // Step 2: Base64 encode to make it JSON-safe
        return btoa(xored);
    },

    /**
     * ⭐ FIXED: Decrypt from Base64 + XOR
     */
    xorDecipher(encrypted, key = CONFIG.message.encryptionKey) {
        try {
            ...
            return encrypted; // Return as-is if fails
        }
    },
